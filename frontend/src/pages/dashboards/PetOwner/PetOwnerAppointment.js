    ...
    <div className="dashboard-container">
      ...
      <main className="main-area">
        ...
        <section className="content-body">
            <div className="appointment-header-action" style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px'}}>
                <h3 style={{fontFamily: 'Poppins', fontWeight: '600'}}>Your Scheduled Visits</h3>
                <button className="book-btn" style={{backgroundColor: '#438fb5', color: 'white', border: 'none', padding: '10px 20px', borderRadius: '8px', cursor: 'pointer'}}>+ Book New Appointment</button>
            </div>
            ...
            <div className="dashboard-welcome-card" style={{background: 'white', padding: '30px', borderRadius: '15px', boxShadow: '0 4px 10px rgba(0,0,0,0.05)'}}>
              <p style={{color: '#555'}}>No appointments found. Start by booking your first visit!</p>
            </div>
        </section>
      </main>
    </div>
