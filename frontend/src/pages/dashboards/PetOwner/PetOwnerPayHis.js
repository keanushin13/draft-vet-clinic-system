    ...
    <div className="dashboard-container">
      ...
      <main className="main-area">
        ...
        <section className="content-body">
            <div className="payment-header-action" style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px'}}>
                <h3 style={{fontFamily: 'Poppins', fontWeight: '600'}}>Transaction History</h3>
                <button className="export-btn" style={{backgroundColor: '#438fb5', color: 'white', border: 'none', padding: '10px 20px', borderRadius: '8px', cursor: 'pointer'}}>Download Statement</button>
            </div>
            ...
            <div className="dashboard-welcome-card" style={{background: 'white', padding: '30px', borderRadius: '15px', boxShadow: '0 4px 10px rgba(0,0,0,0.05)'}}>
              <p style={{color: '#555'}}>No transaction history available. Your receipts and invoices will be listed here after payment.</p>
            </div>
        </section>
      </main>
    </div>
