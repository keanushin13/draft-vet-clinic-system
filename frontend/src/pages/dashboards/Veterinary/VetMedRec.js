      ...
      <main className="main-area">
        ...
        <section className="content-body">
            <div className="dashboard-header-action">
                <h3 style={{fontFamily: 'Poppins', fontWeight: '600', marginBottom: '15px'}}>Patient History Management</h3>
                <p style={{color: '#555', marginBottom: '25px'}}>Search, view, and update the medical records for all clinic patients.</p>
            </div>
