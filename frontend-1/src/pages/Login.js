...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.requiresOtp) {
        // Save email in state for OTP modal
        setLoginEmail(res.data.email || formData.username);
      ...
      // Save email in state (instead of localStorage) for reset password
      setLoginEmail(user.email || formData.username);
  ...
  return (
    <>
      ...
      <Modal show={alertModal.show} onClose={() => setAlertModal({ show: false, message: "" })}>
